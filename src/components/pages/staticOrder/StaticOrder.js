...
let count=0;
  ...
  console.log("datahere from printonorder is "+ dataHere)
...
tble
  ...
  <tbody>
    ...
    {userData.filter((user, index, self) =>
      user.contactOrEmail !== undefined &&

    self.findIndex(u => u.contactOrEmail === user.contactOrEmail) === index)
